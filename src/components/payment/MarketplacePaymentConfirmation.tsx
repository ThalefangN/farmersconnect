...
const MarketplacePaymentConfirmation = () => {
  return (
    <motion.div
    ...
    >
      ...
      >
        Your order is being processed. The farmer will be notified of your purchase.
      ...
      >
        ...
        <ul className="list-disc list-inside mt-2 space-y-1">
          ...
          <li>The farmer will contact you about delivery/pickup</li>
        </ul>
      </motion.div>
    </motion.div>
  );
...
export default MarketplacePaymentConfirmation;